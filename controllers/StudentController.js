...
export const createCV = async (req, res) => {
    try {
        ...
        const newCV = new mongoose.model('Student')({lastName,firstName,Title,phoneNum,adress,socialMediaLinks,competence,languages,skills,hobbies,WorkExperience,education,academicprojects,objective,Bio,user});
